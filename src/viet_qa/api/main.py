...
def ask_question(req: AskRequest):
    ...
    for rank, (idx, ret_score, context) in enumerate(search_results, 1):
        try:
            ...
            # Trọng số điểm không đủ để cản lại sai số của BM25 (chênh nhau rất ít ví dụ 1.0 vs 0.998)
            # Do đó ta CẦN MỘT MỨC PHẠT TUYỆT ĐỐI (Penalty) nếu Reader chọn lộn xộn các Rank dưới.
